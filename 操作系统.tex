...
\tikzset{pics/.cd,
  stapel/.style n args={3}{
    code={\draw (0,0) ellipse (0.75 and 0.3);
    \draw (-0.75,0) -- (-0.75,-4);
    \draw (-0.75,-4) arc (180:360:0.75 and 0.3);
    \draw (-0.75,-3) arc (180:360:0.75 and 0.3);
    \draw (-0.75,-2) arc (180:360:0.75 and 0.3);
    \draw (-0.75,-1) arc (180:360:0.75 and 0.3);
    \draw (0.75,-4) -- (0.75,0);
    \node at (0,-1) {#1};
    \node at (0,-2) {#2};
    \node at (0,-3) {#3};
